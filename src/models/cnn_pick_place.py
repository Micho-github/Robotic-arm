...
def save_cnn_model(model, models_dir: str = "saved_models", filename: str = "cnn_pick_place.pt"):
...
def load_cnn_model(models_dir: str = "saved_models", filename: str = "cnn_pick_place.pt", image_size: int = 64):
    path = os.path.join(models_dir, filename)
