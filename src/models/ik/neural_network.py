...
def get_trained_ik_network(models_dir=os.path.join("saved_models", "robotic_arm"), force_retrain=False):
    """
...
if __name__ == "__main__":
    ...
    # Save
    save_ik_network(model, os.path.join("saved_models", "robotic_arm", "ik_network_3d_pytorch.pt"))
